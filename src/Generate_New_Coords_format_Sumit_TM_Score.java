...
/**
 * Created by maliha.sarwat on 4/8/18.
 */
public class Generate_New_Coords_format_Sumit_TM_Score {
...
//        String[] TO669_proteins = new String[]{"1PQX.pdb", "2K1H.pdb", "2LTL.pdb", "2LTM.pdb"};
        ...
        String[] Casp_12_proteins = new String[]{"2mp4.pdb"};
    ...
    static AVG_PDB.Template readPdb(String pdb_file) {
        ...
        try {
            ...
            String file_path = "/Users/maliha.sarwat/Desktop/NE/Thesis_2017/Data_comparison_2018/Casp12_coords/Sumit_Coords/T0868/";
            ...
            //////*******///// NEW CODE
            File fout = new File("/Users/maliha.sarwat/Desktop/NE/Thesis_2017/Data_comparison_2018/Casp12_coords/Sumit_Coords/T0868/" + "testy" + ".txt");
...
//                        System.out.println("---- Split by space ------");
                    ...
                    try {
                       // if (l.get(2).equals("CA")) {
                            ...
                            for (int p = 0; p < 11; p++) {
                                columns[p] = String.valueOf(l.get(p));
                            }
